...
from social.agent_executor import SocialAgentExecutor
import uvicorn
...
if __name__ == '__main__':
    ...
    request_handler = DefaultRequestHandler(
        agent_executor=SocialAgentExecutor(socialAgent.runner, socialAgent.agent_card), task_store=InMemoryTaskStore()
    )
    server = A2AStarletteApplication(agent_card=socialAgent.agent_card, http_handler=request_handler)
